...
#+BEGIN_SRC yaml :tangle Beispiele/CredentialManagement/docker-compose.yml_v2 
version: '3'
...
#+BEGIN_SRC plaintext :tangle Beispiele/CredentialManagement/app/requirements.txt_v2
mysql-connector-python==8.0.32
hvac==1.1.0
python-dotenv==1.0.0
#+END_SRC
...
#+BEGIN_SRC python :tangle Beispiele/CredentialManagement/app/database.py_v3
import mysql.connector
...
#+BEGIN_SRC python :tangle Beispiele/CredentialManagement/app/main.py_v2
from database import get_all_products
import argparse
...
#+BEGIN_SRC Dockerfile :tangle Beispiele/CredentialManagement/Dockerfile_v3
   FROM python:3.9-slim
